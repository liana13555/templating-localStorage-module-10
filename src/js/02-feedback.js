...
function onFormSubmit(evt) {
  ...
  evt.currentTarget.reset(); // Очищаем форму, сбрасывает значения всех полей
  localStorage.removeItem(STORAGE_KEY);  // Очищаем localStorage
}

/*
 * - Получаем значение поля
 * - Сохраняем его в хранилище localStorage
...
// Это для более сложных форм, с помощью делегирования
